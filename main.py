...
THRESHOLD = 30  # Number of minutes between Falls to make an alert
last_fall = None  # save time stamp of the prev fall
fitToEllipse = False
		...
		if contours:
			...
			if j > 10:
				if last_fall is None:
					...
					delta = time_now - last_fall
					if THRESHOLD < int(delta.total_seconds()//60):
						print("FALL Detected")
						last_fall = time_now
